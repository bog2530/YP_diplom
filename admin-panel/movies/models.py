...
def default_film_permissions() -> list:
    return [PermissionsEnum.READ]
...
class FilmWork(UUIDMixin, TimeStampedMixin):
    ...
    permissions = ArrayField(
        models.CharField(max_length=16, choices=PermissionsEnum.choices),
        default=default_film_permissions,
